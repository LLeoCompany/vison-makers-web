/**
 * LeoFitTech 상담 시스템 - 공유 연락처 정보 폼 컴포넌트
...
export default function ContactInfoForm({
  ...
  const getInputClasses = (hasError: boolean) => `
    w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-${
      THEME_COLORS.PRIMARY_FOCUS
    } focus:border-${THEME_COLORS.PRIMARY_FOCUS} transition-colors duration-200
