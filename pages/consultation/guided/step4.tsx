/**
 * LeoFitTech 상담 시스템 - 가이드 트랙 4단계: 연락처
...
export default function GuidedStep4() {
  ...
  const handleContactTimeChange = (value: string) => {
    setContact(
      { preferredContactTime: value as ContactInfo["preferredContactTime"] },
      "guided"
    );
    ...
    <ConsultationLayout title="연락처 입력" showProgress={true}>
      ...
      <div className="container">
        <div className="card">
          ...
          {/* 기본 정보 */}
          <div className="m-xl">
            <h2 className="text-h3 text-primary m-lg">👤 기본 정보</h2>
          ...
          {/* 연락 희망 시간 */}
          <div className="m-xl">
            <h2 className="text-h3 text-primary m-lg">📞 언제 연락드릴까요?</h2>
                    ...
                    <div className="flex-shrink-0">
                      <div
                        className={`w-6 h-6 rounded-full border-2 ${
                          state.guided.contact.preferredContactTime ===
                          option.value
                            ? "border-red bg-red"
                            : "border-gray-300"
                        }`}
