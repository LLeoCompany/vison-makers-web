/**
 * LeoFitTech 상담 시스템 - 가이드 트랙 2단계: 규모와 예산
...
export default function GuidedStep2() {
  ...
  const { state, setProjectSize, setBudget, nextStep, prevStep } =
    useConsultation();
  ...
  return (
    <ConsultationLayout title="규모와 예산 설정" showProgress={true}>
      <div className="container">
        <div className="card">
          ...
          {/* 프로젝트 규모 */}
          <div className="m-xl">
            <h2 className="text-h3 text-primary m-lg">📏 프로젝트 규모</h2>
                  ...
                  <div className="flex items-start gap-md">
                    <div className="flex-1">
                      <div className="flex items-center gap-sm m-xs">
                        <h3 className="text-h3 text-primary">{option.label}</h3>
                        {option.recommended && (
            ...
            {errors.size && (
              <div className="text-red text-body-sm m-md">{errors.size}</div>
            )}
          </div>

          {/* 예상 예산 */}
          <div className="m-xl">
            <h2 className="text-h3 text-primary m-lg">💰 예상 예산</h2>
            <div className="grid gap-md">
            ...
            {errors.budget && (
              <div className="text-red text-body-sm m-md">{errors.budget}</div>
            )}
          </div>
            ...
            <div className="flex gap-md items-start">
              ...
              <div>
                <p className="text-body text-blue">
                  ...
                  <br />
                  대부분 고객님들이{" "}
                  <span className="text-red">300-800만원 범위</span>에서
                  프로젝트를 진행하십니다.
                  <br />
          ...
          <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-md m-xl">
            ...
            <button
              className={`btn btn-lg order-1 sm:order-2 ${
                state.guided.projectSize && state.guided.budget
                  ? "btn-primary"
                  : "btn-secondary"
              }`}
              onClick={handleNext}
