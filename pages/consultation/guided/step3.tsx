/**
 * LeoFitTech 상담 시스템 - 가이드 트랙 3단계: 일정과 특별 요청
...
export default function GuidedStep3() {
  ...
  const handleAdditionalRequestsChange = (
  ...
  return (
    <ConsultationLayout title="일정과 특별 요청" showProgress={true}>
      <div className="container">
        <div className="card">
          ...
          {/* 완성 희망 시기 */}
          <div className="m-xl">
            <h2 className="text-h3 text-primary m-lg">⏰ 완성 희망 시기</h2>
            ...
            {error && <div className="text-red text-body-sm m-md">{error}</div>}
          </div>
          ...
          <div className="m-xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-md">
              {featureOptions.map((feature) => {
                const isSelected = state.guided.importantFeatures.includes(
                  feature.value
                );
                return (
                  <div
                    ...
                    <div className="flex items-center gap-md">
                      <div
                        className={`w-6 h-6 border-2 rounded flex items-center justify-center transition-all duration-200 ${
                          isSelected ? "border-red bg-red" : "border-gray-300"
                        }`}
                      >
                        {isSelected && (
                          <svg
